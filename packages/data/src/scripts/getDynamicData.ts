import {
    getAllUggChampionData,
    getUggVersion,
    saveAllUggChampionInfo,
} from "../lib/ugg";
import { getChampions, getVersion, saveChampions } from "../lib/ddragon";
...
async function main() {
    ...
    const uggRoleChampionData = await getAllUggChampionData(
        uggVersion,
        champions
    );
